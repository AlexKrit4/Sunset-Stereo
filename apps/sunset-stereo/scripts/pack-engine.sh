...
MATH: 1 000 000 base books + 50 000 buy-bonus books, ~95% RTP, потолок 15000×.
...
2) FRONTEND
   ...
   В ACP выбери папку frontend. В ней должны быть:
     index.html
     assets\   (js, css, png, mp3)
     sunset-scene.jpg
   Не грузи внешние шрифты и не оборачивай папку ещё одним корнем.
   Музыка лежит в assets/, не в отдельной папке audio/.
