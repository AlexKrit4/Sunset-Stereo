  ...
  >
    <div class="sheet" role="dialog" aria-label="Game rules" aria-modal="true">
      ...
      <p>
        ...
        Buy bonus / Get bonus purchases 3 scatters for 95× the selected stake.
        Sun 2 is a toggle: while it is on, each Spin / Play costs 1.5× and always lands a sun on reel 2.
      </p>
      <p>RTP {(GAME.rtp * 100).toFixed(0)}%. Max win {GAME.wincap.toLocaleString()}× of the 1× stake.</p>
      <p>
        Spin / Play starts a round. Sun 2 arms the 1.5× reel-2 sun buy until you turn it off.
        Buy / Get bonus opens the 3-scatter purchase.
